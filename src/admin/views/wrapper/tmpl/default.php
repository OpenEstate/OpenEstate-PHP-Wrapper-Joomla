...
<div id="j-main-container" class="<?php echo $mainContainerClass; ?>">
    ...
    <form action="index.php" method="post">
        <fieldset class="adminform">
            <table>
                <?php foreach ($fieldSet as $field): ?>
                    ...
                    <tr>
                        <td colspan="2"
                            style="font-style:italic; padding-bottom:15px; color:#a0a0a0;"><?php echo JText::_($field->description); ?></td>
                    </tr>
                <?php endforeach; ?>
            </table>
        </fieldset>
        ...
        <input type="submit" value="<?php echo JText::_('COM_OPENESTATE_WRAPPER_SUBMIT'); ?>"
               style="margin-left:15em; margin-top:1em;"/>
    </form>
    ...
    <?php if (isset($this->errors) && is_array($this->errors) && count($this->errors) > 0) : ?>
        ...
        <ul>
            ...
            ?>
            <li>
                <?php echo JText::_('COM_OPENESTATE_WRAPPER_INFO_JOOMLA'); ?><br/>
                <b style="font-family:monospace;"><?php echo JPATH_ROOT; ?></b>
            </li>
        </ul>
    <?php else : ?>
        ...
        <ul>
            <li>
                <?php echo JText::_('COM_OPENESTATE_WRAPPER_INFO_VERSION'); ?>
                <b><?php echo IMMOTOOL_SCRIPT_VERSION; ?></b>
            </li>
            <li>
                <?php echo JText::sprintf('COM_OPENESTATE_WRAPPER_SUCCESS_MESSAGE', 'index.php?option=com_menus'); ?>
            </li>
        </ul>
    <?php endif; ?>
</div>